...
CREATE TABLE IF NOT EXISTS processed_emails (
  ...
  message_id TEXT,
  in_reply_to TEXT,
  "references" TEXT[], -- Quote the reserved keyword
  headers JSONB,
...
-- Create function to increment rule stats (requires email_automation_rules table to exist first)
-- This function will be created in a separate migration after email_automation_rules table is created
